...
export function Footer() {
  const products = [
    { name: "FormEase", href: "#formease" },
    { name: "QRBee", href: "#qrbee" },
    { name: "HackHire", href: "#hackhire" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-gray-300 max-w-md leading-relaxed">
              One hub, many products. Streamline your workflow with our comprehensive SaaS platform.
            </p>
          </div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center text-gray-300 hover:text-white hover:bg-white/20 hover:scale-110 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25"
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-gray-400 text-sm">
            © 2024 Martik.one. All rights reserved.
          </p>
